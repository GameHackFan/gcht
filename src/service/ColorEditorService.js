...
class ColorEditorService
{
  ...
  createColorMap = (colorIndex, channelOrderKey, channelSizeKey, amount = 16) =>
  {
    ...
    if(colorConverterService.isValidColorMainData(cmd))
    {
      ...
      colorMap = {};
      colorMap.decimalAnyList = decimalAnyList;
      colorMap.decimal32List = decimal32List;
      colorMap.hexAnyList = hexAnyList;
      colorMap.hex32List = hex32List;
      colorMap.colorAnyList = colorAnyList;
      colorMap.color32List = color32List;
      colorMap.byteIndexList = byteIndexList;
      colorMap.colorInfo = this.getColorInfo(colorAnyList[7],
...
export const colorEditorService = new ColorEditorService;